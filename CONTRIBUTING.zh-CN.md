...
```
.
├── SKILL.md                 # Skill 入口：frontmatter + 主规范（英文）
├── references/              # 代理按需阅读的详细参考（英文）
│   └── commit-messages.md
├── README.md                # 英文 README（安装与简介）
├── README.zh-CN.md          # 中文 README
├── CONTRIBUTING.md          # 英文贡献指南
├── CONTRIBUTING.zh-CN.md    # 本文件（中文）
├── LICENSE
└── .gitignore
```
...
- `README*` / `CONTRIBUTING*` 面向人类；`SKILL.md` 面向代理（可执行、可扫描）。
...
- 规范性文档（`SKILL.md`、`references/`）使用**英文**。
- 面向人类的文档（`README`、`CONTRIBUTING`）以**英文为主**，各配一份简体中文版（`*.zh-CN.md`）；修改时请保持中英两版同步。
