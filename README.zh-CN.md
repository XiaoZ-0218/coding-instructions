...
- **Conventional Commits 提交规范**：type + 简洁描述（详见 `references/commit-messages.md`）
...
欢迎通过 Issue 或 Pull Request 提出改进建议。请先阅读 [`CONTRIBUTING.zh-CN.md`](./CONTRIBUTING.zh-CN.md)（English: [CONTRIBUTING.md](./CONTRIBUTING.md)）。
